...
accuracy = []
while n_epoch<200:
	clf = MLPClassifier(solver='adam', alpha=1e-5,hidden_layer_sizes=(10, 5), random_state=1, activation = 'relu')
	...
	joblib.dump(clf, '/home/anubhav/Desktop/HW-3-NN/q3'+str(n_epoch)+'.pkl')	
...
# joblib.dump(clf, '/home/anubhav/Desktop/HW-3-NN/q3Model2.pkl')	
