...
clf = MLPClassifier(solver='adam', alpha=1e-5,hidden_layer_sizes=(10, 50,10), random_state=1, activation = 'relu', max_iter= 500)
...
print testY
print acc
joblib.dump(clf, '/home/anubhav/Desktop/HW-3-NN/q3Model3.pkl')	
