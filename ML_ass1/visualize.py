...
X1 ,y1,Y_actual = load_h5py('Data/part_B_train.h5')
j = 0
...
tsne=TSNE(n_components=2).fit_transform(X1)
...
# X1 = np.array(X1)
plt.figure(figsize=(12, 8))
plt.scatter(x_coordinates, y_coordinates, s=40, c=y1, cmap=plt.cm.Paired)
plt.show()
plt.clf()
